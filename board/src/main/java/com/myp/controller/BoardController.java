...
public class BoardController {
	...
	@GetMapping(value= "/listAll") // 주소 호출 명시 . 호출하려는 주소 와 REST 방식설정 (GET)
	...
	@GetMapping(value = "/regist") // GET 방식으로 페이지 호출
	  public void registerGET(BoardVO board, Model model) throws Exception {
	}
	
	@PostMapping(value = "/regist") // POST방식으로 내용 전송
